...
if (isset($_POST["submit"])) {
    ...
    // Insert data into tbl_medical_history
    $sql2 = "INSERT INTO tbl_medical_history (user_id, q1_health_status, q2_donation_rejection, q3_alcohol_intake, 
            q4_heavy_machinery, q5_airplane_travel, q6_tooth_extraction, q7_aspirin_intake, 
            q8_medication_vaccine, q9_1_chickenpox_sores, q9_2_travel_residence_change, 
            q10_doctor_care, q11_1_heart_condition, q11_2_cancer_blood_disorder, 
            q11_3_lung_kidney_epilepsy, q12_malaria_history, q13_hepatitis_liver_issues, 
            q14_uk_europe_travel, q15_1_travel_last_year, q15_2_incarceration, q15_3_illegal_drug_use, 
            q16_1_blood_transfusion, q16_2_tattoo_piercing, q17_1_sexually_transmitted_disease, 
            q17_2_risky_sexual_behavior, q18_donating_for_test_purposes, q19_hiv_awareness, 
            q20_1_currently_pregnant, q20_2_miscarriage_history, q21_last_childbirth, 
            q22_last_menstrual_period
            ) VALUES (
            '$user_id', '$q1_health_status', '$q2_donation_rejection', '$q3_alcohol_intake', 
            '$q4_heavy_machinery', '$q5_airplane_travel', '$q6_tooth_extraction', '$q7_aspirin_intake', 
            '$q8_medication_vaccine', '$q9_1_chickenpox_sores', '$q9_2_travel_residence_change', 
            '$q10_doctor_care', '$q11_1_heart_condition', '$q11_2_cancer_blood_disorder', 
            '$q11_3_lung_kidney_epilepsy', '$q12_malaria_history', '$q13_hepatitis_liver_issues', 
    ...
    if (mysqli_query($con, $sql2)) {
        ...
        echo "<script>alert('Error adding medical history. Please try again.');</script>";
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <hr>
            <form method="post" action="dn_addmedical_history.php" class="medical-history-form">
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q1_health_yes" name="q1_health_status" value="Yes" required>
                        <label for="q1_health_yes">Oo</label>
                        <input type="radio" id="q1_health_no" name="q1_health_status" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q2_donation_yes" name="q2_donation_rejection" value="Yes" required>
                        <label for="q2_donation_yes">Oo</label>
                        <input type="radio" id="q2_donation_no" name="q2_donation_rejection" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q3_alcohol_yes" name="q3_alcohol_intake" value="Yes" required>
                        <label for="q3_alcohol_yes">Oo</label>
                        <input type="radio" id="q3_alcohol_no" name="q3_alcohol_intake" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q4_machinery_yes" name="q4_heavy_machinery" value="Yes" required>
                        <label for="q4_machinery_yes">Oo</label>
                        <input type="radio" id="q4_machinery_no" name="q4_heavy_machinery" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q5_airplane_yes" name="q5_airplane_travel" value="Yes" required>
                        <label for="q5_airplane_yes">Oo</label>
                        <input type="radio" id="q5_airplane_no" name="q5_airplane_travel" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q6_tooth_yes" name="q6_tooth_extraction" value="Yes" required>
                        <label for="q6_tooth_yes">Oo</label>
                        <input type="radio" id="q6_tooth_no" name="q6_tooth_extraction" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q7_aspirin_yes" name="q7_aspirin_intake" value="Yes" required>
                        <label for="q7_aspirin_yes">Oo</label>
                        <input type="radio" id="q7_aspirin_no" name="q7_aspirin_intake" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q8_medication_vaccine_yes" name="q8_medication_vaccine" value="Yes" required>
                        <label for="q8_medication_vaccine_yes">Oo</label>
                        <input type="radio" id="q8_medication_vaccine_no" name="q8_medication_vaccine" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q9_1_chickenpox_sores_yes" name="q9_1_chickenpox_sores" value="Yes" required>
                        <label for="q9_1_chickenpox_sores_yes">Oo</label>
                        <input type="radio" id="q9_1_chickenpox_sores_no" name="q9_1_chickenpox_sores" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q9_2_travel_residence_change_yes" name="q9_2_travel_residence_change" value="Yes" required>
                        <label for="q9_2_travel_residence_change_yes">Oo</label>
                        <input type="radio" id="q9_2_travel_residence_change_no" name="q9_2_travel_residence_change" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q10_doctor_care_yes" name="q10_doctor_care" value="Yes" required>
                        <label for="q10_doctor_care_yes">Oo</label>
                        <input type="radio" id="q10_doctor_care_no" name="q10_doctor_care" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q11_1_heart_condition_yes" name="q11_1_heart_condition" value="Yes" required>
                        <label for="q11_1_heart_condition_yes">Oo</label>
                        <input type="radio" id="q11_1_heart_condition_no" name="q11_1_heart_condition" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q11_2_cancer_blood_disorder_yes" name="q11_2_cancer_blood_disorder" value="Yes" required>
                        <label for="q11_2_cancer_blood_disorder_yes">Oo</label>
                        <input type="radio" id="q11_2_cancer_blood_disorder_no" name="q11_2_cancer_blood_disorder" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q11_3_lung_kidney_epilepsy_yes" name="q11_3_lung_kidney_epilepsy" value="Yes" required>
                        <label for="q11_3_lung_kidney_epilepsy_yes">Oo</label>
                        <input type="radio" id="q11_3_lung_kidney_epilepsy_no" name="q11_3_lung_kidney_epilepsy" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q12_malaria_history_yes" name="q12_malaria_history" value="Yes" required>
                        <label for="q12_malaria_history_yes">Oo</label>
                        <input type="radio" id="q12_malaria_history_no" name="q12_malaria_history" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q13_hepatitis_liver_issues_yes" name="q13_hepatitis_liver_issues" value="Yes" required>
                        <label for="q13_hepatitis_liver_issues_yes">Oo</label>
                        <input type="radio" id="q13_hepatitis_liver_issues_no" name="q13_hepatitis_liver_issues" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q14_uk_europe_travel_yes" name="q14_uk_europe_travel" value="Yes" required>
                        <label for="q14_uk_europe_travel_yes">Oo</label>
                        <input type="radio" id="q14_uk_europe_travel_no" name="q14_uk_europe_travel" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q15_1_travel_last_year_yes" name="q15_1_travel_last_year" value="Yes" required>
                        <label for="q15_1_travel_last_year_yes">Oo</label>
                        <input type="radio" id="q15_1_travel_last_year_no" name="q15_1_travel_last_year" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q15_2_incarceration_yes" name="q15_2_incarceration" value="Yes" required>
                        <label for="q15_2_incarceration_yes">Oo</label>
                        <input type="radio" id="q15_2_incarceration_no" name="q15_2_incarceration" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q15_3_illegal_drug_use_yes" name="q15_3_illegal_drug_use" value="Yes" required>
                        <label for="q15_3_illegal_drug_use_yes">Oo</label>
                        <input type="radio" id="q15_3_illegal_drug_use_no" name="q15_3_illegal_drug_use" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q16_1_blood_transfusion_yes" name="q16_1_blood_transfusion" value="Yes" required>
                        <label for="q16_1_blood_transfusion_yes">Oo</label>
                        <input type="radio" id="q16_1_blood_transfusion_no" name="q16_1_blood_transfusion" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q16_2_tattoo_piercing_yes" name="q16_2_tattoo_piercing" value="Yes" required>
                        <label for="q16_2_tattoo_piercing_yes">Oo</label>
                        <input type="radio" id="q16_2_tattoo_piercing_no" name="q16_2_tattoo_piercing" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q17_1_sexually_transmitted_disease_yes" name="q17_1_sexually_transmitted_disease" value="Yes" required>
                        <label for="q17_1_sexually_transmitted_disease_yes">Oo</label>
                        <input type="radio" id="q17_1_sexually_transmitted_disease_no" name="q17_1_sexually_transmitted_disease" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q17_2_risky_sexual_behavior_yes" name="q17_2_risky_sexual_behavior" value="Yes" required>
                        <label for="q17_2_risky_sexual_behavior_yes">Oo</label>
                        <input type="radio" id="q17_2_risky_sexual_behavior_no" name="q17_2_risky_sexual_behavior" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q18_donating_for_test_purposes_yes" name="q18_donating_for_test_purposes" value="Yes" required>
                        <label for="q18_donating_for_test_purposes_yes">Oo</label>
                        <input type="radio" id="q18_donating_for_test_purposes_no" name="q18_donating_for_test_purposes" value="No" required>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="q19_hiv_awareness_yes" name="q19_hiv_awareness" value="Yes" required>
                        <label for="q19_hiv_awareness_yes">Oo</label>
                        <input type="radio" id="q19_hiv_awareness_no" name="q19_hiv_awareness" value="No" required>
                ...
                <div class="form-group female-only">
                    ...
                    <div>
                        <input type="radio" id="q21_specify_date" name="q21_last_childbirth_option" value="date">
                        <label for="q21_specify_date">Itakda ang petsa:</label>
                        <input type="date" id="q21_last_childbirth" name="q21_last_childbirth" disabled>

                        <div>
                            <input type="radio" id="q21_not_applicable" name="q21_last_childbirth_option" value="not_applicable">
                            <label for="q21_not_applicable">Hindi pa nanganak</label>
                        </div>
                    </div>
                </div>
                <div class="form-group female-only">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        const dateField = document.getElementById("q21_last_childbirth");
        const dateRadio = document.getElementById("q21_specify_date");
        const notApplicableRadio = document.getElementById("q21_not_applicable");

        document.querySelectorAll('input[name="q21_last_childbirth_option"]').forEach(function(radio) {
            radio.addEventListener("change", function() {
                if (dateRadio.checked) {
                    dateField.disabled = false; // Enable date input
                } else {
                    dateField.disabled = true; // Disable date input
                    dateField.value = ""; // Clear any existing value
                }
            });
        });
    });
