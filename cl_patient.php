            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="homepage.php">Edit Patient</a>
                        </li>
                        <li><i class='bx bx-chevron-right'></i></li>
                        <li>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Department</th>
                            <th>Blood Type</th> <!-- This column will now contain both blood type and RH -->
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        // Query to retrieve patient details with blood type and RH joined via bt_id
                        $sql = "
                SELECT 
                    p.patient_id, 
                    p.first_name, 
                        ...
                        if (!$result) {
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td><a href='cl_edit_patient.php?patient_id=" . $row['patient_id'] . "' class='edit-btn'>Edit</a></td>";
                                    echo "</tr>";
                                }
                            } else {
