...
if (!isset($_SESSION['userid'])) {
    ...
    echo "<script>alert('You may now Login your Accout.');</script>";
...
if (isset($_POST["save"])) {
    ...
    $sql = "INSERT INTO tbl_patients (user_id, first_name, middle_name, last_name, age, sex, ward_room, diagnosis, hospital_no, 
                                      ...
                                      Hx_previous_transfusion_where, type_of_request, relationship)
    ...
    if (mysqli_query($con, $sql)) {
        ...
        echo "<script>document.cookie = 'patient_id=' + " . $patient_id . " + ';expires=date;';</script>";
