...
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <section id="overview">
                <h2>About Us</h2>
                <p>Our mission is to connect blood donors with those in need, ensuring a seamless and efficient process
                    for
                    blood donations and requests. By providing a platform where donors can register and seekers can
                    request
